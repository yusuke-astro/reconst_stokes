...
s_par = np.array(Parallel(n_jobs=-1, verbose=5)( [delayed(stokes)(i,I_obs) for i in range(n)] )).T
...
hp.mollview(I_planck[0], title="I_STOKES observed by Planck", unit="mK",norm="hist", cmap="jet")
